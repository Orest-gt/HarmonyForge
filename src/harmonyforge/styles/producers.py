...
METRO_BOOMIN = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=14,
        root_anchor_prob=0.85,         # Strong but mobile bass for dark trap
        darkness_level=0.9,
...
SOUTHSIDE = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=12,
        root_anchor_prob=0.85,         # Aggressive bass focus
        darkness_level=0.95,
...
MIKE_DEAN = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=24,
        root_anchor_prob=0.75,         # More melodic bass freedom
        darkness_level=0.7,
        tension_preference=0.9,
...
ATL_JACOB = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=18,
        root_anchor_prob=0.85,         # Solid groove foundation
...
TAY_KEITH = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        root_anchor_prob=0.90,         # Aggressive root-focused bass
        darkness_level=0.92,
...
NICK_MIRA = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        repetition_tendency=0.55,      # Reduced for more variety between beats
        melodic_range=16,              # Strong melodic range for emotional leads
        root_anchor_prob=0.90,         # Strong root anchor for solid 808 foundation
...
FORTY = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=13,
        root_anchor_prob=0.80,         # Steady, professional bass
        darkness_level=0.45,
...
WHEEZY = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=11,
        root_anchor_prob=0.85,         # Dark trap bass focus
        darkness_level=0.90,
...
BOI_1DA = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        repetition_tendency=0.65,
        melodic_range=15,
        root_anchor_prob=0.80,         # Professional pop/r&b bass
        darkness_level=0.60,
        tension_preference=0.70,
...
HIT_BOY = ProducerProfile(
    ...
    signature=StyleSignature(
        ...
        melodic_range=14,
        root_anchor_prob=0.80,         # Solid hip-hop foundation
        darkness_level=0.70,
